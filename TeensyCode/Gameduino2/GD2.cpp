...
#else
#define SD_PIN        BUILTIN_SDCARD     // pin used for the microSD enable signal
#endif


#define BOARD_NHD_7       2
#define BOARD_FTDI_80x    1
#define BOARD_GAMEDUINO23 0
...
static const uint8_t bpltab[] = { // was static const PROGMEM
/* 0  ARGB1555  */ 0,
/* 1  L1        */ 4,
/* 2  L4        */ 2,
/* 3  L8        */ 1,
...
begin1:
  ...
  GDTR.wr(REG_CSPREAD,0);
  GDTR.wr(REG_DITHER,1);
  GDTR.wr(REG_PCLK_POL,1);
  GDTR.wr(REG_PCLK,2);
  ...
  Clear(); swap();
  Clear(); swap();
  cmd_regwrite(REG_PWM_DUTY, 128);//128
  flush();
...
static const uint16_t sintab[257] = {// was static const PROGMEM
...
static const uint8_t atan8[] = {// was static const PROGMEM
...
static const uint8_t __bsod[32] = { // was static const PROGMEM
0, 255, 255, 255, 96, 0, 0, 2, 7, 0, 0, 38, 12, 255, 255, 255, 240, 0,
90, 0, 31, 0, 0, 6, 69, 82, 82, 79, 82, 0, 0, 0
};
static const uint8_t __bsod_badfile[32] = {// was static const PROGMEM
